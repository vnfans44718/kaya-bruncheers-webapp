	                ...
	                <table class="table">
                        ...
                        <tr>
                        	<td>
                        		...
                        		<input type="text" class="form-control" name="bTitle" maxlength="50" value="<%=board.getBTitle()%>">
                        	</td>
                        </tr>
                        <tr>
                            <td>
						...
						<tr>
							<td align=center><input type="button" value="수정하기" class="genric-btn primary-border" onClick="boardUpdate()"> &nbsp; 
