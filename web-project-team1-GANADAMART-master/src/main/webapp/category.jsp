...
<%
	...
	if (sortValue == 0) {
	    switch (categoryValue) {
	        ...
	        case 5:
	        case 6:
	            productList = productService.productListByCategory(categoryValue);
	            break;
	    }
	} else if (sortValue == 1) {
	    switch (categoryValue) {
	    	case 0:
            	productList = productService.productListOrderByPopularity();
            	break;
	        case 1:
	        case 2:
	        case 3:
	        ...
	        case 5:
	        case 6:
	            productList = productService.productListByCategoryOrderByPopularity(categoryValue);
	            break;
	    }
	} else if (sortValue == 2) {
	    switch (categoryValue) {
	    	case 0:
        		productList = productService.productListOrderByPriceHigh();
        		break;
	        case 1:
	        case 2:
	        case 3:
	        ...
	        case 5:
	        case 6:
	            productList = productService.productListByCategoryOrderByPriceHigh(categoryValue);
	            break;
	    }
	} else if (sortValue == 3) {
	    switch (categoryValue) {
	   		 case 0:
    			productList = productService.productListOrderByPriceLow();
    			break;
	        case 1:
	        case 2:
	        case 3:
	        ...
	        case 5:
	        case 6:
	            productList = productService.productListByCategoryOrderByPriceLow(categoryValue);
	            break;
	    }
	} 
    ...
    <section class="banner-area organic-breadcrumb">
        <div class="container">
            <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                <div class="col-first">
                    <h1 style="color: #CF1010">Shopping</h1>
			...
			<div class="col-xl-3 col-lg-4 col-md-5">
				<div class="sidebar-categories">
					...
					<ul class="main-categories">
						...
						<li class="main-nav-list"><a href="category.jsp?category=1&sort=0" ><span class="lnr lnr-arrow-right"></span>
						<%if(categoryValue==1){
							out.print("<span style=\"color: #ffba00\">스니커즈</span>");
						} else {
							out.print("스니커즈");
						}
						%>
						...
						<li class="main-nav-list"><a href="category.jsp?category=2&sort=0" ><span class="lnr lnr-arrow-right"></span>
						<%if(categoryValue==2){
							out.print("<span style=\"color: #ffba00\">스포츠</span>");
						} else {
							out.print("스포츠");
						}
						%>
						...
						<li class="main-nav-list"><a href="category.jsp?category=3&sort=0" ><span class="lnr lnr-arrow-right"></span>
						<%if(categoryValue==3){
							out.print("<span style=\"color: #ffba00\">구두</span>");
						} else {
							out.print("구두");
						}
						%>
						...
						<li class="main-nav-list"><a href="category.jsp?category=4&sort=0" ><span class="lnr lnr-arrow-right"></span>
						<%if(categoryValue==4){
							out.print("<span style=\"color: #ffba00\">샌들</span>");
						} else {
							out.print("샌들");
						}
						%>
						...
						<li class="main-nav-list"><a href="category.jsp?category=5&sort=0" ><span class="lnr lnr-arrow-right"></span>
						<%if(categoryValue==5){
							out.print("<span style=\"color: #ffba00\">캐주얼</span>");
						} else {
							out.print("캐주얼");
						}
						%>
						...
						<li class="main-nav-list"><a href="category.jsp?category=6&sort=0">
						<%if(categoryValue==6){
							out.print("<span style=\"color: #ffba00\">부츠</span>");
						} else {
							out.print("부츠");
						}
						%>
			...
			<div class="col-xl-9 col-lg-8 col-md-7">
				...
				<div class="filter-bar d-flex flex-wrap align-items-center">
					<div class="sorting">
						...
						<ul class="list">
							<li data-value="1" class="option"><a href="category.jsp?category=<%=categoryValue%>&sort=1">베스트상품순</li>
							<li data-value="1" class="option"><a href="category.jsp?category=<%=categoryValue%>&sort=2">높은가격순</li>
							<li data-value="1" class="option"><a href="category.jsp?category=<%=categoryValue%>&sort=3">낮은가격순</li></a>
						</ul>
					</div>
				</div>
