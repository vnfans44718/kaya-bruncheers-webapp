...
%>
        <script type="text/javascript">
            ...
            window.location.href = "user_modifyCheck_form.jsp";
        </script>
...
<script type="text/javascript" charset="UTF-8"
   src="https://maps.googleapis.com/maps-api-v3/api/js/56/1/intl/ko_ALL/common.js"></script>
<script type="text/javascript" charset="UTF-8"
   src="https://maps.googleapis.com/maps-api-v3/api/js/56/1/intl/ko_ALL/util.js"></script>
    ...
    <section class="banner-area organic-breadcrumb">
        <div class="container">
            <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                <div class="col-first">
                    <h1 style="color: #CF1010">Update</h1>
   ...
   <div class="row justify-content-center">
      <div class="col-lg-6 justify-content-center">
         ...
         <div class="login_form_inner">
            ...
            <form name="f" class="row login_form" action="contact_process.php"
               method="post" id="contactForm" novalidate="novalidate">
               <div class="col-md-12 form-group">
                  아이디 <input type="text" class="form-control text-center" id="uId"
                     name="uId" placeholder="아이디" value="<%=user.getUId()%>" readonly>
               </div>


               <div class="col-md-12 form-group">
                  이름 <input type="text" class="form-control text-center" id="uName"
                     name="uName" value="<%=user.getUName()%>" readonly>
               </div>
               ...
               <div class="col-md-12 form-group">
                  ...
                  <div class="input-group">
                     <input type="email" class="form-control text-center" id="uEmail"
                        name="uEmail" value="<%=user.getUEmail()%>" readonly>
                  </div>
               </div>
               <div class="col-md-12 form-group">
                  비밀번호 <input type="password" class="form-control text-center"
                     id="uPass" name="uPass" value="<%=user.getUPass()%>" onfocus="">


               </div>
               <div class="col-md-12 form-group">
                  비밀번호 확인 <input type="password" class="form-control text-center"
                     id="uPass2" name="uPass2" value="<%=user.getUPass()%>" onfocus="">
               </div>


               <div class="col-md-12 form-group">
                  전화번호 <input type="text" class="form-control text-center"
                     id="uPhone" name="uPhone" value="<%=user.getUPhone()%>" oninput="phoneMask(this)" maxlength="13">
               </div>
                <script>
               function addHyphen() {
               ...
               <div class="col-md-12 form-group">
                  주소 <input type="text" class="form-control text-center" id="uAddr"
                     name="uAddr" value="<%=user.getUAddr()%>" onfocus=""> <input
                     type="button" onclick="addressApi()" value="우편번호 찾기">
               </div>


               <div class="col-md-12 form-group">
                  <button type="button" value="수정" onclick="userModifyAction();"
                     class="genric-btn primary radius" style="padding: 5px 80px; font-size: 20px;">수정</button>
               </div>
            </form>
         </div>
      </div>
