	                ...
	                <table class="table">
	                   <tr>
                            <td>
                            	...
                            	<input type="text" class="form-control" name="uId" maxlength="100" value="<%=board.getUId()%>" >
                            </td>
                        </tr>
                        <tr>
                        	<td>
                        		<label for="f-option3">제목</label><br><br>
                        		<input type="text" class="form-control" name="bTitle" maxlength="50" value="[RE]<%=board.getBTitle()%>">
                        	</td>
                        </tr>
                        <tr>
                            <td>
                            	<label for="f-option3">내용</label><br><br>
                            	<textarea class="form-control" name="bContent" maxlength="3000" style="height: 350px; resize:none;" >>><%=board.getBContent().replace("\n",">>").trim()%></textarea>
                            </td>
                        </tr>
						<tr>
							<td align=center><input type="button" value="작성" class="genric-btn primary-border" onClick="boardCreate()"> &nbsp; 
								<input type="button" value="게시판 리스트" class="genric-btn primary-border" onClick="boardList()"></td>
						</tr>
	                </table>
				</form>
            </div>
