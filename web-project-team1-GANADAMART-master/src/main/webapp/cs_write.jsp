	                   ...
	                   <tr>
                        ...
                        <tr>
                        	<td>
                        		...
                        		<input type="text" class="form-control" name="csTitle" maxlength="50" >
                        	</td>
                        </tr>
                        <tr>
                            <td>
                            	<label for="f-option3">내용</label><br><br>
                            	<textarea class="form-control" name="csContent" maxlength="3000" style="height: 350px; resize:none;" ></textarea>
                            </td>
                        </tr>
                        <tr>
							<td align=center><input type="button" value="작성" class="genric-btn primary-border" onClick="csCreate()"> &nbsp; 
