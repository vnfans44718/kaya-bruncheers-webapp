	                ...
	                <table class="table">
	                   <tr>
                            <td>
                            	...
                            	<input type="text" class="form-control" name="uId" maxlength="100" value="<%=sUserId%>" readonly="readonly">
                            </td>
                        </tr>
                        <tr>
                        	<td>
                        		<label for="f-option3">제목</label><br><br>
                        		<input type="text" class="form-control" name="bTitle" maxlength="50" >
                        	</td>
                        </tr>
                        <tr>
                            <td>
                            	<label for="f-option3">내용</label><br><br>
                            	<textarea class="form-control" name="bContent" maxlength="3000" style="height: 350px; resize:none;" ></textarea>
                            </td>
                        </tr>
						<tr>
