...
<script type="text/javascript">
	...
	function userModify(){
		document.f.action='user_modifyCheck_form.jsp';
	...
	function userRemove(){
		...
		if (window.confirm("탈퇴하시겠습니까?")){
			document.f.action = "user_removeCheck_form.jsp";
			document.f.method='POST';
			document.f.submit();
		}
	}
    ...
    <section class="banner-area organic-breadcrumb">
        <div class="container">
            <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                <div class="col-first">
                    <h1 style="color: #CF1010">My Info</h1>
	...
	<div class="row justify-content-center">
		<div class="col-lg-6 justify-content-center">
			...
			<div class="login_form_inner">
				...
				<form name="f" class="row login_form" action="contact_process.php"  method="post"
					id="contactForm" novalidate="novalidate">
					<div class="col-md-12 form-group">아이디
 						<input type="text" class="form-control text-center" id="uId" name="uId" 
							value="<%=user.getUId() %>" readonly >
							
					</div>
					
					<div class="col-md-12 form-group">이름
						<input type="text" class="form-control text-center" id="uName"
							name="uName" value="<%=user.getUName()  %>" readonly
							>
					</div>
					
					<div class="col-md-12 form-group">전화번호
						<input type="text" class="form-control text-center" id="uPhone" name="uPhone"
							value="<%=user.getUPhone() %>" readonly
							>
					</div>
			
					<div class="col-md-12 form-group">이메일
						<div class="input-group">
							<input type="email" class="form-control text-center" id="uEmail" name="uEmail"
					...
					<div class="col-md-12 form-group">주소
						<input type="text" class="form-control text-center" id="uAddr"
							name="uAddr" value="<%=user.getUAddr() %>" readonly 
							>
					</div>

					<div class="col-md-12 form-group">
						<button type="button" value="수정" onclick="userModify()"
							class="genric-btn primary-border radius" style="padding: 5px 40px; font-size: 15px;">수정</button>
						<button type="button" value="탈퇴" onclick="userRemove()"
							class="genric-btn primary-border radius" style="padding: 5px 40px; font-size: 15px;">탈퇴</button>
					</div>
