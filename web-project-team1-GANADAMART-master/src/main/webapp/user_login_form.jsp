...
<script type="text/javascript">
    ...
    function openFindIdPopup() {
        ...
        window.open("user_findId_form.jsp", "아이디 찾기", "width=" + width + ",height=" + height + ",left=" + left + ",top=" + top);
    }
    ...
    function openFindPasswordPopup() {
        var width = 600;
                ...
                window.open("user_findPassword_form.jsp", "비밀번호 찾기", "width=" + width + ",height=" + height + ",left=" + left + ",top=" + top);
    }

    function findPassword() {
        window.location.href = "user_findPassword_form.jsp";
    }
    ...
    <section class="banner-area organic-breadcrumb">
        <div class="container">
            <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                <div class="col-first">
                    <h1 style="color: #CF1010">Login</h1>
				...
				<div class="col-lg-6">
					<div class="login_box_img">
						...
						<div class="hover">
							<h4>첫 방문이신가요?</h4>
							<p>회원가입을 해보세요.</p>
							<a class="primary-btn" href="user_create_form.jsp">회원가입</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="login_form_inner">
						<h3>로그인</h3>
						<form name="f" class="row login_form" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="uId" name="uId" placeholder="아이디" onfocus="this.placeholder = ''" onblur="this.placeholder = '아이디'" value="<%= fuser.getUId() %>">
								&nbsp;&nbsp;<font color="red"><%= msg1 %></font>
							</div>
							<div class="col-md-12 form-group">
								<input type="password" class="form-control" id="uPass" name="uPass" placeholder="비밀번호" onfocus="this.placeholder = ''" onblur="this.placeholder = '비밀번호'" value="<%= fuser.getUPass() %>">
								&nbsp;&nbsp;<font color="red"><%= msg2 %></font>
							</div>
							<div class="col-md-12 form-group">
								<button type="button" value="로그인" onclick="login();" class="primary-btn">로그인</button>
								<a onclick="openFindIdPopup()">아이디 찾기</a>
								<a onclick="openFindPasswordPopup()">비밀번호 찾기</a>
							</div>
						</form>
					</div>
				</div>
